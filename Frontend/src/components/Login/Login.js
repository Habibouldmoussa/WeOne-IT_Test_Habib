...
const Login = () => {
    ...
    return (
        <form onSubmit={handleSubmitLogin} className={Styles.login} >
            ...
            <p className={Styles.login__feature}><span><input type="checkbox" onClick={(event) => setMaxAge(" ")} id="rememberMe" /><label htmlFor="rememberMe">Remember me</label></span> <span>Forgot password ?</span></p>
